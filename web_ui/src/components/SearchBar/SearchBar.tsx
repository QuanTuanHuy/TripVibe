...
// Mock data cho gợi ý địa điểm
const locationSuggestions = [
  { id: 1, name: 'Hà Nội', country: 'Việt Nam', type: 'city', propertyCount: 5123 },
  { id: 2, name: 'Hồ Chí Minh', country: 'Việt Nam', type: 'city', propertyCount: 6521 },
  { id: 3, name: 'Đà Nẵng', country: 'Việt Nam', type: 'city', propertyCount: 2451 },
  { id: 4, name: 'Hội An', country: 'Việt Nam', type: 'city', propertyCount: 1328 },
  { id: 5, name: 'Đà Lạt', country: 'Việt Nam', type: 'city', propertyCount: 1845 },
  { id: 6, name: 'Nha Trang', country: 'Việt Nam', type: 'city', propertyCount: 2156 },
  { id: 7, name: 'Phú Quốc', country: 'Việt Nam', type: 'region', propertyCount: 986 },
  { id: 8, name: 'Hạ Long', country: 'Việt Nam', type: 'city', propertyCount: 743 }
];
...
const SearchBar: React.FC<SearchBarProps> = ({
  ...
  const handleSearch = () => {
    ...
    // Chuyển hướng đến trang tìm kiếm với tham số
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              {location.type === 'city' ? 'Thành phố' : 'Khu vực'} ở {location.country} · {location.propertyCount} chỗ nghỉ
                            </div>
                          </div>
                        </div>
                      ))
