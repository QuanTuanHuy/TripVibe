...
import huy.project.accommodation_service.core.domain.kafka.inventory.SyncUnitDto;
...
public class AddUnitUseCase {
    ...
    public void pushMessageToKafka(Long accId, Long unitId) {
        ...
        var syncUnitInventory = SyncUnitDto.from(unit);
        ...
        kafkaPublisher.pushAsync(syncUnitInventory.toKafkaBaseDto(), TopicConstant.InventoryCommand.TOPIC, null);
    }
}
